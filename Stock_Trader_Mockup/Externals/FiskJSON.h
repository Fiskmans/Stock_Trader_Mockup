...
#include "../Stock_Trader_Mockup/pch.h"
...
namespace FiskJSON
{
	...
	class Leaf : public Object { Leaf() = delete; };
...
#pragma region Is
	...
	template<>
	inline bool Object::Is<Object>()
	{
		return  this && myType == Type::Object;
	}

	template<>
	inline bool Object::Is<Leaf>()
	{
		return  this && myType == Type::Value;
	}
